  ...
  <div class="aftersale">
    <div class="header">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px">
        ...
        <el-breadcrumb-item :to="{ path: '/' }">售后仅退款</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-steps :active="2" finish-status="success" simple style="margin-top: 20px">
      <el-step title="1.买家申请仅退款"></el-step>
      <el-step title="2.卖家处理仅退款"></el-step>
      <el-step title="3.退款完毕"></el-step>
    </el-steps>
    <div class="order_content">
      <div class="left">
        <div class="title_top"><span>请处理仅退款消申请</span><i class="el-icon-time"></i><em>还剩2天23时45分</em></div>
        <div class="notice">如果用户在此阶段撤销申请，则订单状态转为成功，本页面刷新为退款处理完毕</div>
        ...
        <div style="height: 100px;border-bottom: 1px solid #f5f7fa;margin-top:30px">
          ...
          <el-button @click="dialogFormVisible = true">拒绝申请（请填写拒绝原因）</el-button>
        </div>
      ...
      <div class="right">
        ...
        <div class="bottom">
          ...
          <p>收货状态:<span>已收到货物</span></p>
          <p>退款原因:<span>收货信息有误</span></p>
          <p>退款描述:<span>收货信息有误</span></p>
          <ul>
