<template>
	<div class="orderstate5">
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>订单状态-交易成功</el-breadcrumb-item>
		</el-breadcrumb>
    <el-button style="float: right;" type="primary"  size="mini"  icon="el-icon-back" @click="$router.back(-1)">返回</el-button>
    <p class="explanation"><i class="el-icon-document"></i>订单状态-交易成功</p>
		...
		<div class="ordertime">
			...
			<div class="timeinfo">
				<b>发货时间：</b><br />
				<span>{{tableData.sendtime}}</span>
			</div>
			<div class="timeinfo">
				<b>成交时间：</b><br />
				<span>{{tableData.affirmtime}}</span>
			</div>
		</div>
		<div class="orderstate1">
			<p>当前订单状态：买家确认收货，交易成功</p>
			<li>交易成功，提醒买家评价商品，会带来更多购买量哦。</li>
			<li>交易成功，如果买家提出售后要求，请积极与买家协商，做好售后服务。</li>
			<li>如果买家提前确认收货，包裹还未全部送达，记得跟踪物流信息，给买家一个好的购物体验。</li>
		</div>
