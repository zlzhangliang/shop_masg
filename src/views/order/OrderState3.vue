<template>
	<div class="orderstate3">
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>订单状态-等待买家收货</el-breadcrumb-item>
		</el-breadcrumb>
    <el-button style="float: right;" type="primary"  size="mini"  icon="el-icon-back" @click="$router.back(-1)">返回</el-button>
    <p class="explanation"><i class="el-icon-document"></i>订单状态-等待买家收货</p>
		...
		<div class="orderstate1">
			<p>当前订单状态：卖家已发货，等待买家收货</p>
			<li>任一包裹发货，订单视为已发货（等待买家收货）。</li>
			<li>同城配送和同城配送（即时达）包裹，跑腿员确认操作后，订单完成发货操作。</li>
			<li>多包裹订单发货后，买家将收到多个包裹，请积极跟踪物流，及时和买家沟通。</li>
		</div>
