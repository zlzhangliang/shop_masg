<template>
  <div class="chatList">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>官方客服列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!--卡片查询-->
    ...
    <el-card class="card-list">
      ...
      <el-table
        ...
        <el-table-column label="操作" width="104">
          <template slot-scope="scope">
            <strong  @click="getInfo(scope.row.group_id)"><span style="margin-left: 10px;color: #13ce66;">查看</span></strong>
            <strong  @click="handleDelete(scope.row.group_id)"><span style="margin-left: 10px;color: #CBD0D6;" >删除</span></strong>
          </template>
        </el-table-column>
      </el-table>
      <!--底部-->
