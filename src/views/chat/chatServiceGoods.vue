<template>
  <div class="chatService" >
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: 'chatListGoods' }">客服处理</el-breadcrumb-item>
      <el-breadcrumb-item>商品客服</el-breadcrumb-item>
    </el-breadcrumb>
    <!--商品信息及用户名称-->
    <hr/>
    <div class="main">
      <div class="m-message">
        <div style="overflow:hidden;margin-bottom: 10px">
          ...
          <div style="height: 100px;width: 100px;float: left;margin-right: 15px" v-if="goodsInfo.img">
            <img :src="goodsInfo.img[0]" style="width: 100px;height: 100px;"/>
          </div>
          <p class="content">{{goodsInfo.goods_name}}</p>
        </div>
        <p class="title">用户名称：</p><span class="name">{{goodsInfo.nickname}}</span>
        ...
        <!--聊天内容-->
        <ul class="chatList" v-for="(site,index) in chatContent">
          <!--用户的消息-->
          ...
          <!--客服的消息-->
          <li v-else-if="site.user_id == '88881'" class="chatTitle-my">
  ...
  export default {
    ...
    methods: {
      ...
      getCount() {
        ...
        apiChat.getChatContent(param).then(res => {
          console.log(res);
          if(res.cscode == "0"){
