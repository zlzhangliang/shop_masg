      ...
      <el-button style="float: right" type="primary" icon="el-icon-plus" @click="$router.push('goodsupdate')">发布商品</el-button>
		...
		<el-table ref="multipleTable" border :data="tableData1" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" @select-all="checkAll">
          ...
          <div style="position: relative">
            ...
            <span style="padding: 2px 6px;color: red;border-radius:20px;border: 1px solid red;position: absolute;left: 50px;top:30px;z-index: 99" v-if="scope.row.types==3">限</span>
            ...
            <div class="isPeiSong" style="position: absolute;left:0px;top: 30px"> 支持配送：{{ scope.row.dml_type | myDmlType }}</div>
          </div>
				</template>
			</el-table-column>
        ...
        <template slot-scope="scope">
          ...
          <p v-if="scope.row.is_lack==1" style="color: red">将售罄</p>
        </template>
			</el-table-column>
      ...
      <el-table-column prop="repertory"label="总销量">
		...
		<div style="margin-top: 20px">
          ...
          :page-sizes="[10,20,30]" layout="total, sizes, prev, pager, next, jumper" >
			...
			<el-button type="info"  @click="soldout">下架</el-button>
			<el-button type="danger" @click="del">删除</el-button>
		</div>

    <!--<el-dialog-->
      <!--:title="iteminfo.modelchage=='price'?'修改价格':'修改库存'"-->
      <!--:visible.sync="modelchage">-->
      <!--<el-row v-if="iteminfo.modelchage=='price'">-->
        <!--<el-col :span="8"><div class="grid-content bg-purple-dark">{{iteminfo.name}}</div></el-col>-->
        <!--<el-col :span="16"><div class="grid-content bg-purple-dark"></div><el-input v-model="iteminfo.price" placeholder="请输入价格"></el-input></el-col>-->
      <!--</el-row>-->
      <!--<el-row v-if="iteminfo.modelchage=='stock'">-->
        <!--<el-col :span="8"><div class="grid-content bg-purple-dark">{{iteminfo.name}}</div></el-col>-->
        <!--<el-col :span="16"><div class="grid-content bg-purple-dark"></div><el-input v-model="iteminfo.stock" placeholder="请输入价格"></el-input></el-col>-->
      <!--</el-row>-->
      <!--<span slot="footer" class="dialog-footer">-->
    <!--<el-button @click="modelchage = false">取 消</el-button>-->
    <!--<el-button type="primary" @click="modelchage = false">确 定</el-button>-->
  <!--</span>-->
    <!--</el-dialog>-->
    <el-dialog
