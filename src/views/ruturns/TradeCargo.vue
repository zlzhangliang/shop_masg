	  ...
	  <div style="margin-top: 20px">
	   ...
	   <el-dialog title="订单备注" :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
			<div class="ordernotes">
				...
				<p>申请时间：{{oktime}} </p>
				<p><span>订单实收款(元)：{{aaa}}元 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  退货物流单号：{{numbers}}</span></p> 
				<p><span>退款金额（元）：{{bbb}}元  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 退货状态：{{zhuangtai}}</span></p>
				...
				<p><span>会员名：{{vipname}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  成交时间：{{ok_time}}</span></p> 
				<p><span>联系方式：{{phone}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 购买数量：x{{amount}}</span></p>
				...
				<hr />
				<p style="color: red;">换货详情：</p>
				<p><span>会员名：{{vipname}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  成交时间：{{ok_time}}</span></p> 
				<p><span>联系方式：{{phone}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 换货数量：x{{replacement_number}}</span></p>
				<div style="height: 200px; width: 800px;">
					<span> 
						<img src="../../assets/img/wifi.jpg" style="height: 150px; width: 150px;" alt="" align="center"/>					
							【测试数据切勿真实购买】简约大气质感皮面套脚正装鞋货号：52026-2颜色：黑色；尺寸：37；
					</span>
				</div>
    ...
    data() {
      return {
		...
		remark:'。。。。。',//备注
      	...
      	numbers:'鼠标滑过，调用合作物流SDK接口，根据系统数据显示当前退货物流跟踪信息',//退货编号
      	zhuangtai:'已退回',//退货状态
      	
      	//会员名
		vipname:'张三丰',//    	判断输入
		ok_time:'2018-08-07 10:41:35',//成交时间
		amount:'2',//退货数量
		replacement_number:'13',//换货数量
		phone:'16638019329',//联系电话
