<template>
  <div class="AccountStatementabnormal">
    <div class="header">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">财务</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/accountList' }">对账管理</el-breadcrumb-item>
        <el-breadcrumb-item>对账详情异常</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button type="primary" icon="el-icon-refresh">返回</el-button>
    </div>
    <div class="btn_box">
      <ul>
        ...
        <li>
          ...
          <table class="mailTable" >
            ...
            <tr>
              ...
              <td style="box-sizing: border-box;padding: 5px"><input type="text" v-model="Remarks" style="width: 100%;height: 40px;padding-left:10px;box-sizing: border-box "></td>
            </tr>
          </table>
        </li>
      </ul>
      <el-button type="primary" @click="subRemarks"  style="margin: 0 auto;display: block;">冲正处理</el-button>
    </div>
  </div>
</template>
      ...
      methods:{
        ...
        getdetail:function () {
          ...
          apifinance.viewTheDetails(param).then(res=>{
            console.log(res)
            if(res.cscode=="0"){
              if(res.data.data.finance_status=="2"){
                res.data.data.finance_status ="异常"
              }
        ...
        subRemarks:function () {
          ...
          apifinance.finance_Remark(param).then(res=>{
            console.log(res);
