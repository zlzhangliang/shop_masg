      ...
      <ul>
        <li>
          ...
          <table class="mailTable" >
            ...
            <tr>
              ...
              <td>{{datas.mode_payment==1 ?'微信':'暂无'}}</td>
            </tr>
            <tr>
        ...
        <li>
          ...
          <table class="mailTable" >
            ...
            <tr>
              <td class="column">对账人员</td>
              <td>{{datas.finance_name}}</td>
            </tr>
            <tr>
              <td class="column">对账时间</td>
              <td>{{chuan(datas.finance_time)}}</td>
            </tr>
            <tr>
              <td class="column">处理备注</td>
              <td>{{datas.finance_remark}}</td>
            </tr>
          </table>
        </li>
      </ul>
      ...
      methods:{
        getdetail:function () {
          ...
          apifinance.viewTheDetails(param).then(res=>{
            console.log(res)
            if(res.cscode=="0"){
              if(res.data.data.finance_status=="3"){
                res.data.data.finance_status ="已冲正"
              }
