      ...
      <ul>
        ...
        <li>
          ...
          <table class="mailTable" >
            ...
            <tr>
              <td class="column">对账人</td>
              <td>{{datas.finance_name}}</td>
            </tr>
            <tr>
              <td class="column">对账时间</td>
              <td>{{datas.finance_time ? chuan(datas.finance_time) :'暂无'}}</td>
            </tr>
          </table>
        </li>
      </ul>
      ...
      methods:{
        getdetail:function () {
          ...
          apifinance.viewTheDetails(param).then(res=>{
            console.log(res)
            if(res.cscode=="0"){
              if(res.data.data.finance_status=="1"){
                res.data.data.finance_status ="已对账"
              }
